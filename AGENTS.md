...
- **Text autodescriptiu amb rols** (`_group_who`): "solapament d'horaris que afecta 1 entrenador" / "…12 jugadors" / "…2 jugadors, 1 reforç"; margins: "{who} amb marge de desplaçament just". Rol per persona = el de més pes (coach > delegate > reinforce > player); lectura: jugadors, reforços, entrenadors, delegats. Fallback "solapament d'horaris: N persones".
