...
HELP: dict[str, list[dict]] = {
    "ca": [
            ...
            "questions": [
                {
                    ...
                    "link": "/season/{season_id}/trainings/solapes"
                },
                {
        ...
        },
        {
            ...
            "questions": [
                {
                    "q": "Com començo la configuració inicial?",
                    "a": "La primera vegada, l'assistent et guia pas a pas a través de temporades, club, pistes, franges, equips i persones. També pots reprendre'l des del menú d'ajuda.",
                    "link": "/assistant"
                }
            ]
        },
        {
            "id": "hores",
            "title": "Hores setmanals d'entrenament",
            "questions": [
                {
                    "q": "Com assigno les hores setmanals de cada equip?",
                    "a": "Ves a Entrenaments → Hores i indica les hores setmanals per equip; aquests valors són la base per generar propostes automàtiques.",
                    "link": "/trainings/hours"
                }
            ]
        },
        {
            "id": "auto-conflicts",
            "title": "Resolució automàtica de conflictes",
            "questions": [
                {
                    "q": "Pot resoldre AtempoSports alguns conflictes automàticament?",
                    "a": "Sí. A la pàgina de resolució automàtica l'aplicació prova alternatives vàlides seguint les preferències de franges i solapaments.",
                    "link": "/conflicts/auto"
                }
            ]
        },
        {
            "id": "federation-changes",
            "title": "Canvis de la federació",
            "questions": [
                {
                    "q": "Com reviso els canvis de la federació?",
                    "a": "La pàgina de canvis federatius mostra les actualitzacions detectades als partits importats. També pots accedir-hi des de la fitxa d'un partit concret.",
                    "link": "/federation-changes"
                },
                {
                    "q": "Com edito un partit amb canvi federatiu?",
                    "a": "Des de la fitxa del partit pots obrir la pàgina de canvi federatiu per actualitzar l'hora o la data a partir del que envia la federació.",
                    "link": "/matches/{match_id}/change"
                }
            ]
        },
        {
            "id": "import-csv",
            "title": "Importació CSV",
            "questions": [
                {
                    "q": "Com importo dades amb CSV?",
                    "a": "A la pàgina Temporada → Dades pots pujar un fitxer CSV per importar equips, persones, franges o partits. Segueix l'exemple del format.",
                    "link": "/season/{season_id}/data"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "Com exporto els partits?",
                    "a": "Ves a Exportar partits i descarrega un CSV amb totes les convocatòries de la temporada.",
                    "link": "/export/matches"
                },
                {
                    "q": "I els entrenaments?",
                    "a": "A Exportar entrenaments pots descarregar un CSV amb les sessions programades.",
                    "link": "/export/trainings"
                }
            ]
        },
        {
            "id": "trainings-by-team",
            "title": "Entrenaments per equip",
            "questions": [
                {
                    "q": "Com veure els entrenaments d'un equip concret?",
                    "a": "A Entrenaments per equip veus una vista agrupada amb totes les sessions assignades a cada equip. És útil per revisar càrregues setmanals.",
                    "link": "/trainings/by-team"
                }
            ]
        },
        {
            "id": "team-alias-link",
            "title": "Àlies d'equip i enllaç federatiu",
            "questions": [
                {
                    "q": "Com vinculo un equip amb una federació?",
                    "a": "A la pàgina Equips → Enllaç pots associar un equip a un nom de federació perquè els partits s'importin correctament.",
                    "link": "/teams/link"
                },
                {
                    "q": "Com afegeixo un àlies per importar?",
                    "a": "A Importar àlies pots definir noms alternatius d'equip per facilitar la importació de partits.",
                    "link": "/import/alias"
                }
            ]
        },
        {
            "id": "conflict-training-edit",
            "title": "Editar entrenament des del conflicte",
            "questions": [
                {
                    "q": "Puc editar un entrenament des de la fitxa del conflicte?",
                    "a": "Sí. Quan entres al detall d'un conflicte i toca un entrenament, pots obrir-lo directament per editar horari, pista o equip.",
                    "link": "/conflict/{conflict_id}/training-edit"
                }
            ]
        },
        {
            "id": "ignore-conflicts",
            "title": "Ignorar i desfer conflictes",
            "questions": [
                {
                    "q": "Puc ignorar un conflicte?",
                    "a": "Sí. Si un conflicte no és rellevant, pots marcar-lo com a ignorat. Més tard també el pots tornar a mostrar (des-ignorar) des de la llista de conflictes.",
                    "link": "/season/{season_id}/conflicts"
                }
            ]
        },
        {
            "id": "advanced-groups",
            "title": "Gestió avançada de grups",
            "questions": [
                {
                    "q": "Quines accions avançades puc fer als grups?",
                    "a": "Pots proposar, generar borrador, importar borrador, netejar importacions, treure equips, trencar, fusionar, esborrar un dia i gestionar solapaments. Cada acció està al menú del grup.",
                    "link": "/season/{season_id}/trainings/groups"
                }
            ]
        },
        {
            "id": "solapaments-vista",
            "title": "Visualitzador de solapaments",
            "questions": [
                {
                    "q": "Com veure tots els solapaments de la temporada?",
                    "a": "El visualitzador de solapaments mostra un quadre on cada fila és un equip i cada columna un dia. És útil per detectar col·locacions i ajustar-les.",
                    "link": "/overlaps"
                }
            ]
        },
        {
            "id": "person-unavailability",
            "title": "Indisponibilitat de persones",
            "questions": [
                {
                    "q": "Com marco que una persona no està disponible?",
                    "a": "A la fitxa de la persona hi ha una secció d'indisponibilitats. Pots afegir franges puntuals o recurrents perquè l'aplicació les respecti quan proposi.",
                    "link": "/people/{person_id}/unavailability"
                }
            ]
        },
        {
            "id": "season-copy",
            "title": "Còpia de temporada",
            "questions": [
                {
                    "q": "Com copio una temporada?",
                    "a": "Des de la pàgina de còpia de temporada pots duplicar la configuració, equips i persones d'una temporada a una altra, sense fer la renovació anual.",
                    "link": "/season/{season_id}/copy"
                }
            ]
        },
        {
            "id": "batch-trainings",
            "title": "Edició i esborrat per lots",
            "questions": [
                {
                    "q": "Com edito o esborro molts entrenaments alhora?",
                    "a": "Selecciona els entrenaments des de la llista i tria 'Editar en lot' o 'Esborrar'/'Netejar'. Pots canviar hora, pista o equip, o buidar el calendari d'entrenaments.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        },
        {
            "id": "manual-recurring",
            "title": "Entrenaments manuals i recurrents",
            "questions": [
                {
                    "q": "Com afegeixo entrenaments manuals o recurrents?",
                    "a": "Pots crear entrenaments puntuals o definir un patró setmanal recurrent. Aquestes sessions s'afegeixen directament al calendari sense passar pel borrador.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        }
...
EXTRA_HELP: dict[str, list[dict]] = {
    "es": [
        ...
        },
        {
            ...
            "questions": [
                {
                    "q": "¿Cómo empiezo la configuración inicial?",
                    "a": "La primera vez, el asistente te guía paso a paso por temporadas, club, pistas, franjas, equipos y personas. También puedes reanudarlo desde el menú de ayuda.",
                    "link": "/assistant"
                }
            ]
        },
        {
            "id": "hores",
            "title": "Horas semanales de entrenamiento",
            "questions": [
                {
                    "q": "¿Cómo asigno las horas semanales de cada equipo?",
                    "a": "Ve a Entrenamientos → Horas e indica las horas semanales por equipo. Esos valores son la base para generar propuestas automáticas.",
                    "link": "/trainings/hours"
                }
            ]
        },
        {
            "id": "auto-conflicts",
            "title": "Resolución automática de conflictos",
            "questions": [
                {
                    "q": "¿Puede resolver AtempoSports los conflictos automáticamente?",
                    "a": "Sí. En la resolución automática la aplicación prueba alternativas válidas según las preferencias de franjas y solapamientos.",
                    "link": "/conflicts/auto"
                }
            ]
        },
        {
            "id": "federation-changes",
            "title": "Cambios de la federación",
            "questions": [
                {
                    "q": "¿Cómo reviso los cambios de la federación?",
                    "a": "La página de cambios federativos muestra las actualizaciones detectadas en los partidos importados. También puedes acceder desde la ficha de un partido concreto.",
                    "link": "/federation-changes"
                },
                {
                    "q": "¿Cómo edito un partido con cambio federativo?",
                    "a": "Desde la ficha del partido puedes abrir la página de cambio federativo para actualizar la hora o la fecha a partir de lo que envía la federación.",
                    "link": "/matches/{match_id}/change"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "¿Cómo importo datos con CSV?",
                    "a": "En la página Temporada → Datos puedes subir un archivo CSV para importar equipos, personas, franjas o partidos. Sigue el ejemplo del formato.",
                    "link": "/season/{season_id}/data"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "¿Cómo exporto los partidos?",
                    "a": "Ve a Exportar partidos y descarga un CSV con todas las convocatorias de la temporada.",
                    "link": "/export/matches"
                },
                {
                    "q": "¿Y los entrenamientos?",
                    "a": "En Exportar entrenamientos puedes descargar un CSV con las sesiones programadas.",
                    "link": "/export/trainings"
                }
            ]
        },
        {
            "id": "trainings-by-team",
            "title": "Entrenamientos por equipo",
            "questions": [
                {
                    "q": "¿Cómo veo los entrenamientos de un equipo concreto?",
                    "a": "En Entrenamientos por equipo ves una vista agrupada con todas las sesiones asignadas a cada equipo. Es útil para revisar las cargas semanales.",
                    "link": "/trainings/by-team"
                }
            ]
        },
        {
            "id": "team-alias-link",
            "title": "Alias de equipo y enlace federativo",
            "questions": [
                {
                    "q": "¿Cómo vinculo un equipo con una federación?",
                    "a": "En la página Equipos → Enlace puedes asociar un equipo a un nombre de federación para que los partidos se importen correctamente.",
                    "link": "/teams/link"
                },
                {
                    "q": "¿Cómo añado un alias para importar?",
                    "a": "En Importar alias puedes definir nombres alternativos de equipo para facilitar la importación de partidos.",
                    "link": "/import/alias"
                }
            ]
        },
        {
            "id": "conflict-training-edit",
            "title": "Editar entrenamiento desde el conflicto",
            "questions": [
                {
                    "q": "¿Puedo editar un entrenamiento desde la ficha del conflicto?",
                    "a": "Sí. Cuando entras en el detalle de un conflicto y afecta a un entrenamiento, puedes abrirlo directamente para editar horario, pista o equipo.",
                    "link": "/conflict/{conflict_id}/training-edit"
                }
            ]
        },
        {
            "id": "ignore-conflicts",
            "title": "Ignorar y deshacer conflictos",
            "questions": [
                {
                    "q": "¿Puedo ignorar un conflicto?",
                    "a": "Sí. Si un conflicto no es relevante, puedes marcarlo como ignorado. Más tarde también puedes volver a mostrarlo (des-ignorar) desde la lista de conflictos.",
                    "link": "/season/{season_id}/conflicts"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "¿Qué acciones avanzadas puedo hacer en los grupos?",
                    "a": "Puedes proponer, generar borrador, importar borrador, limpiar importaciones, quitar equipos, romper, fusionar, borrar un día y gestionar solapamientos. Cada acción está en el menú del grupo.",
                    "link": "/season/{season_id}/trainings/groups"
                }
            ]
        },
        {
            "id": "solapaments-vista",
            "title": "Visualizador de solapamientos",
            "questions": [
                {
                    "q": "¿Cómo veo todos los solapamientos de la temporada?",
                    "a": "El visualizador de solapamientos muestra un cuadro en el que cada fila es un equipo y cada columna un día. Es útil para detectar colocaciones y ajustarlas.",
                    "link": "/overlaps"
                }
            ]
        },
        {
            "id": "person-unavailability",
            "title": "Indisponibilidad de personas",
            "questions": [
                {
                    "q": "¿Cómo marco que una persona no está disponible?",
                    "a": "En la ficha de la persona hay una sección de indisponibilidades. Puedes añadir franjas puntuales o recurrentes para que la aplicación las respete al proponer.",
                    "link": "/people/{person_id}/unavailability"
                }
            ]
        },
        {
            "id": "season-copy",
            "title": "Copia de temporada",
            "questions": [
                {
                    "q": "¿Cómo copio una temporada?",
                    "a": "Desde la página de copia de temporada puedes duplicar la configuración, equipos y personas de una temporada a otra, sin hacer la renovación anual.",
                    "link": "/season/{season_id}/copy"
                }
            ]
        },
        {
            "id": "batch-trainings",
            "title": "Edición y borrado por lotes",
            "questions": [
                {
                    "q": "¿Cómo edito o borro muchos entrenamientos a la vez?",
                    "a": "Selecciona los entrenamientos desde la lista y elige 'Editar en lote' o 'Borrar'/'Limpiar'. Puedes cambiar hora, pista o equipo, o vaciar el calendario de entrenamientos.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        },
        {
            "id": "manual-recurring",
            "title": "Entrenamientos manuales y recurrentes",
            "questions": [
                {
                    "q": "¿Cómo añado entrenamientos manuales o recurrentes?",
                    "a": "Puedes crear entrenamientos puntuales o definir un patrón semanal recurrente. Estas sesiones se añaden directamente al calendario sin pasar por el borrador.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        }
    ...
    "en": [
        ...
        },
        {
            ...
            "questions": [
                {
                    "q": "How do I start the initial setup?",
                    "a": "The first time, the setup wizard guides you step by step through seasons, club, venues, slots, teams and people. You can also resume it from the help menu.",
                    "link": "/assistant"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "How do I set weekly training hours for each team?",
                    "a": "Go to Trainings → Hours and enter the weekly hours per team. These values are the basis for automatic proposals.",
                    "link": "/trainings/hours"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "Can AtempoSports resolve conflicts automatically?",
                    "a": "Yes. In auto resolution the app tries valid alternatives according to slot and overlap preferences.",
                    "link": "/conflicts/auto"
                }
            ]
        },
        {
            "id": "federation-changes",
            "title": "Federation changes",
            "questions": [
                {
                    "q": "How do I review federation changes?",
                    "a": "The federation changes page shows updates to imported matches. You can also access it from a match's detail.",
                    "link": "/federation-changes"
                },
                {
                    "q": "How do I edit a match with a federation change?",
                    "a": "From the match detail you can open the federation change page to update the time or date sent by the federation.",
                    "link": "/matches/{match_id}/change"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "How do I import data using CSV?",
                    "a": "In Season → Data you can upload a CSV file with teams, people, slots or matches. Follow the format example.",
                    "link": "/season/{season_id}/data"
                }
            ]
        },
            ...
            "questions": [
                {
                    ...
                    "a": "Go to Export matches and download a CSV with all the season fixtures.",
                    "link": "/export/matches"
                },
                {
                    "q": "What about trainings?",
                    "a": "On Export trainings you can download a CSV with the scheduled sessions.",
                    "link": "/export/trainings"
                }
            ]
        },
        {
            "id": "trainings-by-team",
            "title": "Trainings by team",
            "questions": [
                {
                    "q": "How do I view the trainings for a specific team?",
                    "a": "In Trainings by team you see all sessions grouped by team, with weekly load. Useful for reviewing and adjusting.",
                    "link": "/trainings/by-team"
                }
            ]
        },
        {
            "id": "team-alias-link",
            "title": "Team alias and federation link",
            "questions": [
                {
                    "q": "How do I link a team to a federation?",
                    "a": "In Teams → Link you can associate a team with its official federation name so matches are imported correctly.",
                    "link": "/teams/link"
                },
                {
                    "q": "How do I add an alias for import?",
                    "a": "In Import alias you can define alternative team names to make importing matches easier.",
                    "link": "/import/alias"
                }
            ]
        },
        {
            "id": "conflict-training-edit",
            "title": "Edit training from conflict",
            "questions": [
                {
                    "q": "Can I edit a training from a conflict's detail?",
                    "a": "Yes. From the conflict detail, if the affected activity is a training, there is a button to edit it directly.",
                    "link": "/conflict/{conflict_id}/training-edit"
                }
            ]
        },
        {
            "id": "ignore-conflicts",
            "title": "Ignore and unignore conflicts",
            "questions": [
                {
                    "q": "Can I ignore a conflict?",
                    "a": "Yes. From the conflicts list you can ignore those you do not want to handle. If you change your mind, you can show them again.",
                    "link": "/season/{season_id}/conflicts"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "What advanced actions can I do in groups?",
                    "a": "In the group menu you can propose, generate draft, import draft, clear imports, remove team, break, merge and delete a day. You can also manage overlaps.",
                    "link": "/season/{season_id}/trainings/groups"
                }
            ]
        },
        {
            "id": "solapaments-vista",
            "title": "Overlap viewer",
            "questions": [
                {
                    "q": "How do I see all season overlaps?",
                    "a": "The overlap viewer shows a grid with teams and days to detect placements and adjust them.",
                    "link": "/overlaps"
                }
            ]
        },
        {
            "id": "person-unavailability",
            "title": "Person unavailability",
            "questions": [
                {
                    "q": "How do I mark someone unavailable?",
                    "a": "On the person's profile, under Unavailability, you can add one-off or recurring slots. AtempoSports will respect them when proposing.",
                    "link": "/people/{person_id}/unavailability"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "How do I copy a season?",
                    "a": "The season copy page lets you duplicate configuration, teams and people from one season to another, without doing the annual renewal.",
                    "link": "/season/{season_id}/copy"
                }
            ]
        },
        {
            "id": "batch-trainings",
            "title": "Batch training edit/delete and clear",
            "questions": [
                {
                    "q": "How do I edit or delete many trainings at once?",
                    "a": "From the training list, select several and choose 'Batch edit' or 'Delete'/'Clear'. You can change venue, time or team, or empty the training calendar.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        },
        {
            "id": "manual-recurring",
            "title": "Manual and recurring trainings",
            "questions": [
                {
                    "q": "How do I add manual or recurring trainings?",
                    "a": "You can create one-off trainings or a weekly recurring pattern. These trainings are placed directly on the calendar without going through the draft.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        }
    ...
    "eu": [
        ...
        {
            "id": "setup",
            "title": "Konfigurazio laguntzailea",
            "questions": [
                {
                    "q": "Nola hasten dut konfigurazio hasierakoa?",
                    "a": "Lehenengo aldiz, laguntzaileak urratsez urrats gidatuko zaitu: denboraldiak, kluba, pistak, tarteak, taldeak eta pertsonak. Laguntza menuan berriro hasi dezakezu.",
                    "link": "/assistant"
                }
            ]
        },
        {
            "id": "hores",
            "title": "Asteeko entrenamendu orduak",
            "questions": [
                {
                    "q": "Nola esleitutako asteeko orduak talde bakoitzeko?",
                    "a": "Zoaz Entrenamenduak → Orduak eta adierazi asteeko orduak talde bakoitzeko. Balio horiek proposamen automatikoak sortzeko oinarria dira.",
                    "link": "/trainings/hours"
                }
            ]
        },
        {
            "id": "auto-conflicts",
            "title": "Gatazken konponketa automatikoa",
            "questions": [
                {
                    "q": "AtempoSports-ek gatazkak automatikoki konpondu ditzake?",
                    "a": "Bai. Ebazpen automatikoan aplikazioak baliozko alternatibak probatzen ditu tarte eta gainjartze hobespenak jarraituz.",
                    "link": "/conflicts/auto"
                }
            ]
        },
        {
            "id": "federation-changes",
            "title": "Federazioaren aldaketak",
            "questions": [
                {
                    "q": "Nola berrikusi ditzakedan federazioaren aldaketak?",
                    "a": "Federazio-aldaketen orrialdeak inportatutako partiduetan egindako eguneraketak erakusten ditu. Partidu baten fitxatik ere sartu zaitezke.",
                    "link": "/federation-changes"
                },
                {
                    "q": "Nola editatzen dut federazio-aldaketa duen partidu bat?",
                    "a": "Partiduaren fitxatik federazio-aldaketen orrialdera ireki dezakezu, federazioak bidalitako ordua edo data eguneratzeko.",
                    "link": "/matches/{match_id}/change"
                }
            ]
        },
        {
            "id": "import-csv",
            "title": "CSV inportazioa",
            "questions": [
                {
                    "q": "Nola inportatu ditzakedan datuak CSV bidez?",
                    "a": "Denboraldia → Datuak atalean taldeak, pertsonak, tarteak edo partiduak dituen CSV igo dezakezu. Formatuaren adibidea jarraitu.",
                    "link": "/season/{season_id}/data"
                }
            ]
        },
        {
            "id": "export-csv",
            "title": "CSV esportazioa",
            "questions": [
                {
                    "q": "Nola esportatzen ditut partiduak?",
                    "a": "Zoaz Esportatu partiduak eta denboraldi osoko deialdiak dituen CSVa deskargatu.",
                    "link": "/export/matches"
                },
                {
                    "q": "Eta entrenamenduak?",
                    "a": "Esportatu entrenamenduak orrian programatutako saioak dituen CSVa deskarga dezakezu.",
                    "link": "/export/trainings"
                }
            ]
        },
        {
            "id": "trainings-by-team",
            "title": "Entrenamenduak taldeka",
            "questions": [
                {
                    "q": "Nola ikus ditzakedan talde jakin bateko entrenamenduak?",
                    "a": "Entrenamenduak taldeka ikuspegiak talde bakoitzeko saioak biltzen ditu, asteeko kargarekin. Berrikusteko eta doitzeko erabilgarria da.",
                    "link": "/trainings/by-team"
                }
            ]
        },
        {
            "id": "team-alias-link",
            "title": "Talde ezizena eta federazio-lotura",
            "questions": [
                {
                    "q": "Nola lotzen dut talde bat federazio batekin?",
                    "a": "Taldeak → Lotu atalean taldea federazioaren izen ofizialarekin lotu dezakezu, partiduak ondo inportatzeko.",
                    "link": "/teams/link"
                },
                {
                    "q": "Nola gehitzen dut inportatzeko ezizena?",
                    "a": "Inportatu ezizenak orrian talde-izen alternatiboak defini ditzakezu, partiduak inportatzera errazteko.",
                    "link": "/import/alias"
                }
            ]
        },
        {
            "id": "conflict-training-edit",
            "title": "Gatazkatik entrenamendua editatu",
            "questions": [
                {
                    "q": "Gatazka baten fitxatik entrenamendua editatu dezaket?",
                    "a": "Bai. Gatazkaren xehetasunetik, jarduera entrenamendua bada, zuzenean editatzeko botoia dago.",
                    "link": "/conflict/{conflict_id}/training-edit"
                }
            ]
        },
        {
            "id": "ignore-conflicts",
            "title": "Gatazkak alde batera utzi eta berriro erakutsi",
            "questions": [
                {
                    "q": "Gatazka bat alde batera utzi dezaket?",
                    "a": "Bai. Gatazken zerrendatik ez dituzu nahi tratatuak alde batera utzi ditzakezu. Geroago, berriro erakutsi ditzakezu.",
                    "link": "/season/{season_id}/conflicts"
                }
            ]
        },
        {
            "id": "advanced-groups",
            "title": "Talde-multzoen kudeaketa aurreratua",
            "questions": [
                {
                    "q": "Zein ekintza aurreratu egin ditzakedan multzoetan?",
                    "a": "Multzoaren menuan proposatu, zirriborroa sortu, zirriborroa inportatu, inportazioak garbitu, taldeak kendu, apurtu, fusionatu eta egun bat ezabatu egin ditzakezu. Gainjartzeak ere kudea ditzakezu.",
                    "link": "/season/{season_id}/trainings/groups"
                }
            ]
        },
        {
            "id": "solapaments-vista",
            "title": "Gainjartze ikusleihoa",
            "questions": [
                {
                    "q": "Nola ikusten ditut denboraldi osoko gainjartzeak?",
                    "a": "Gainjartze ikusleihoak taldeak eta egunak dituen taula bat erakusten du, kokapenak hautemateko eta doitzeko.",
                    "link": "/overlaps"
                }
            ]
        },
        {
            "id": "person-unavailability",
            "title": "Pertsonen ez-erabilgarritasuna",
            "questions": [
                {
                    "q": "Nola markatzen dut pertsona bat ez dagoela erabilgarri?",
                    "a": "Pertsonaren fitxan, Ez-erabilgarritasunak atalean, tarte puntualak edo errepikariak gehi ditzakezu. AtempoSports-ek proposatzean kontuan hartuko ditu.",
                    "link": "/people/{person_id}/unavailability"
                }
            ]
        },
        {
            "id": "season-copy",
            "title": "Denboraldiaren kopia",
            "questions": [
                {
                    "q": "Nola kopiatzen dut denboraldi bat?",
                    "a": "Denboraldia kopiatu orrialdeak konfigurazioa, taldeak eta pertsonak denboraldi batetik bestera kopiatzeko aukera ematen du, urteroko berritzea egin gabe.",
                    "link": "/season/{season_id}/copy"
                }
            ]
        },
        {
            "id": "batch-trainings",
            "title": "Entrenamenduen edizioa eta ezabatzea sortan",
            "questions": [
                {
                    "q": "Nola editatu edo ezabatu ditzakedan entrenamendu asko aldi berean?",
                    "a": "Entrenamenduen zerrendatik, hainbat hautatu eta 'Editatu sortan' edo 'Ezabatu'/'Garbitu' aukeratu. Pista, ordua edo taldea alda ditzakezu, edo egutegia garbi.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        },
        {
            "id": "manual-recurring",
            "title": "Eskuzko eta errepikariak diren entrenamenduak",
            "questions": [
                {
                    "q": "Nola gehitzen ditut eskuzko edo errepikariak diren entrenamenduak?",
                    "a": "Entrenamendu puntualak edo asteerako errepikapen bat sor ditzakezu. Entrenamendu hauek zuzenean egutegian jartzen dira, zirriborrorik gabe.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        }
    ...
    "gl": [
        ...
        },
        {
            ...
            "questions": [
                {
                    "q": "Como comezo a configuración inicial?",
                    "a": "A primeira vez, o asistente guíache paso a paso por tempadas, club, pistas, franxas, equipos e persoas. Tamén podes retomalo dende o menú de axuda.",
                    "link": "/assistant"
                }
            ]
        },
        {
            "id": "hores",
            "title": "Horas semanais de adestramento",
            "questions": [
                {
                    "q": "Como asigno as horas semanais de cada equipo?",
                    "a": "Vai a Adestramentos → Horas e indica as horas semanais por equipo. Eses valores son a base para xerar propostas automáticas.",
                    "link": "/trainings/hours"
                }
            ]
        },
        {
            "id": "auto-conflicts",
            "title": "Resolución automática de conflitos",
            "questions": [
                {
                    "q": "Pode resolver AtempoSports os conflitos automaticamente?",
                    "a": "Si. Na resolución automática a aplicación proba alternativas válidas segundo as preferencias de franxas e solapamentos.",
                    "link": "/conflicts/auto"
                }
            ]
        },
        {
            "id": "federation-changes",
            "title": "Cambios da federación",
            "questions": [
                {
                    "q": "Como reviso os cambios da federación?",
                    "a": "A páxina de cambios federativos mostra as actualizacións detectadas nos partidos importados. Tamén podes acceder dende a ficha dun partido concreto.",
                    "link": "/federation-changes"
                },
                {
                    "q": "Como edito un partido con cambio federativo?",
                    "a": "Dende a ficha do partido podes abrir a páxina de cambio federativo para actualizar a hora ou a data segundo o enviado pola federación.",
                    "link": "/matches/{match_id}/change"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "Como importo datos con CSV?",
                    "a": "Na páxina Tempada → Datos podes subir un ficheiro CSV para importar equipos, persoas, franxas ou partidos. Segue o exemplo do formato.",
                    "link": "/season/{season_id}/data"
                }
            ]
        },
        {
            ...
            "questions": [
                {
                    "q": "Como exporto os partidos?",
                    "a": "Vai a Exportar partidos e descarga un CSV con todas as convocatorias da tempada.",
                    "link": "/export/matches"
                },
                {
                    "q": "E os adestramentos?",
                    "a": "En Exportar adestramentos podes descargar un CSV coas sesións programadas.",
                    "link": "/export/trainings"
                }
            ]
        },
        {
            "id": "trainings-by-team",
            "title": "Adestramentos por equipo",
            "questions": [
                {
                    "q": "Como vexo os adestramentos dun equipo concreto?",
                    "a": "En Adestramentos por equipo verás todas as sesións agrupadas por equipo, coa carga semanal. É útil para revisar e axustar.",
                    "link": "/trainings/by-team"
                }
            ]
        },
        {
            "id": "team-alias-link",
            "title": "Alias de equipo e enlace federativo",
            "questions": [
                {
                    "q": "Como vinculo un equipo con unha federación?",
                    "a": "Na páxina Equipos → Enlace podes asociar un equipo ao seu nome oficial de federación para que os partidos se importen correctamente.",
                    "link": "/teams/link"
                },
                {
                    "q": "Como engado un alias para importar?",
                    "a": "En Importar alias podes definir nomes alternativos de equipo para facilitar a importación de partidos.",
                    "link": "/import/alias"
                }
            ]
        },
        {
            "id": "conflict-training-edit",
            "title": "Editar adestramento dende o conflito",
            "questions": [
                {
                    "q": "Podo editar un adestramento dende a ficha dun conflito?",
                    "a": "Si. Dende o detalle do conflito, se a actividade afectada é un adestramento, hai un botón para editalo directamente.",
                    "link": "/conflict/{conflict_id}/training-edit"
                }
            ]
        },
        {
            "id": "ignore-conflicts",
            "title": "Ignorar e desfacer conflitos",
            "questions": [
                {
                    "q": "Podo ignorar un conflito?",
                    "a": "Si. Dende a lista de conflitos podes ignorar os que non queiras tratar. Se cambias de opinión, podes volver a mostralos.",
                    "link": "/season/{season_id}/conflicts"
                }
            ]
        },
        {
            "id": "advanced-groups",
            "title": "Xestión avanzada de grupos",
            "questions": [
                {
                    "q": "Que accións avanzadas podo facer nos grupos?",
                    "a": "No menú do grupo podes propoñer, xerar borrador, importar borrador, limpar importacións, quitar equipos, romper, fusionar e borrar un día. Tamén podes xestionar solapamentos.",
                    "link": "/season/{season_id}/trainings/groups"
                }
            ]
        },
        {
            "id": "solapaments-vista",
            "title": "Visualizador de solapamentos",
            "questions": [
                {
                    "q": "Como vexo todos os solapamentos da tempada?",
                    "a": "O visualizador de solapamentos mostra un cadro onde cada fila é un equipo e cada columna un día. É útil para detectar colocacións e axustalas.",
                    "link": "/overlaps"
                }
            ]
        },
        {
            "id": "person-unavailability",
            "title": "Indisponibilidade de persoas",
            "questions": [
                {
                    "q": "Como marco que unha persoa non está dispoñible?",
                    "a": "Na ficha da persoa, en Indisponibilidades, podes engadir franxas puntuais ou recorrentes. AtempoSports respectaraas ao propoñer.",
                    "link": "/people/{person_id}/unavailability"
                }
            ]
        },
        {
            "id": "season-copy",
            "title": "Copia de tempada",
            "questions": [
                {
                    "q": "Como copio unha tempada?",
                    "a": "A páxina de copia de tempada permite duplicar a configuración, equipos e persoas dunha tempada a outra, sen facer a renovación anual.",
                    "link": "/season/{season_id}/copy"
                }
            ]
        },
        {
            "id": "batch-trainings",
            "title": "Edición e borrado por lotes",
            "questions": [
                {
                    "q": "Como edito ou borro moitos adestramentos á vez?",
                    "a": "Dende a lista de adestramentos, selecciona varios e escolle 'Editar en lote' ou 'Borrar'/'Limpar'. Podes cambiar pista, hora ou equipo, ou baleirar o calendario de adestramentos.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        },
        {
            "id": "manual-recurring",
            "title": "Adestramentos manuais e recorrentes",
            "questions": [
                {
                    "q": "Como engado adestramentos manuais ou recorrentes?",
                    "a": "Podes crear adestramentos puntuais ou un patrón semanal recorrente. Estes adestramentos colócanse directamente no calendario sen pasar polo borrador.",
                    "link": "/season/{season_id}/trainings"
                }
            ]
        }
